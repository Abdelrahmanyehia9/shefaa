...
class SpecialtyCategoryCard extends StatelessWidget {
  ...
  static const String _title = "قلب";
  static const String _doctorsCount = "432 دكتور";
  ...
  Widget _buildIconChip(
    ...
    return CircleChip(
      child: CategorySVG(color: color, size: height),
    );
  }
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              AppText(_title, style: context.textTheme.labelMedium, height: 0),
              AppText(
                _doctorsCount,
