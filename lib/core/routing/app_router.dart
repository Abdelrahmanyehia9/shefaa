...
import 'package:shefaa/shared/presentation/view/filters_screen.dart';
...
class AppRouter {
  Route? generateRoute(RouteSettings settings) {
    ...
    providers: [
    BlocProvider(create: (context)=>sl<GetDoctorAvailabilityCubit>()..getDoctorAvailability(args.doctor.id)),
    BlocProvider(create: (context)=>sl<CreateBookingCubit>())
    ],
    child: BookDoctorScreen(
    args: args,
    ),
    ), name: Routes.bookDoctor);

      case Routes.filters:
        return _page(FiltersScreen(), name: Routes.filters);
    default:
    return null;
    }
  }
